...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    category: "Player",
    content:
      "In what experts are calling 'the worst trade in Arklet history,' user noobmaster69 traded their complete collection of 2,847 Arks — including 3 Celestials — for a single Common-rarity Ark they 'thought looked cool.' When reached for comment, noobmaster69 said: \"Wait, you can't undo trades?\" A moment of silence was held in the global chat.",
  },
  {
    id: "8",
    emoji: "👶",
  ...
  },
  {
    id: "9",
    emoji: "🎬",
    title: "Netflix Announces 'Ark Wars' Reality Show — 16 Players, One Divine",
