  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 max-w-2xl mx-auto">
        ...
        {/* Column Headers */}
         <div className="grid grid-cols-[60px_1fr_100px_80px_80px] gap-4 px-4 py-2 text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-2">
          <div>Rank</div>
          <div>Player</div>
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: index * 0.05 }}
                   className={`grid grid-cols-[60px_1fr_100px_80px_80px] gap-4 items-center 
                  ...
                  <div className="text-center">
                   ...
                   <div className="text-center">
                     <div className="flex items-center justify-center gap-1">
                       ...
                       <span className="font-bold text-foreground">{entry.successful_trades}</span>
                     </div>
                  </div>
                </motion.div>
              );
